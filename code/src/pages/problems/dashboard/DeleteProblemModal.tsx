...
interface Assessment {
  ...
  const DeleteProblemModal = ({ problemId, problemTitle }: DeleteProblemModalProps) => {
    ...
    const { data, isLoading: isChecking, refetch } = useQuery({
    ...
    const activeAssessments = data?.assessments?.filter((assessment: Assessment) => {
          ...
          <ModalContent>
              ...
              {isChecking ? (
                ...
                <div className="space-y-4">
                  <p className="text-gray-600">
                    Are you sure you want to delete "<span className="font-medium">{problemTitle}</span>"?
                  </p>
                  ...
                  {activeAssessments.length > 0 ? (
                    <Alert className="bg-yellow-50 border-yellow-200">
                      ...
                      <AlertDescription className="text-yellow-800">
                        This problem cannot be deleted as it is currently in use in the following active assessments:
                    ...
                    <Alert className="bg-green-50 border-green-200">
                      ...
                      <AlertDescription className="text-green-800">
                        This problem can be safely deleted as it is not used in any active assessments.
                      </AlertDescription>
                    </Alert>
                  )}
                </div>
            ...
            <ModalFooter>
              ...
              <Button
                ...
                disabled={isChecking || activeAssessments.length > 0 || deleteMutation.isPending}
              >
