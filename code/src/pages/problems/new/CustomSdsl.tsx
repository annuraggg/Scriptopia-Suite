...
const CustomSdslEditor = ({ onClose, codeState, setCodeState }: CustomSdslEditorProps) => {
            ...
            <div className="w-64 border-r border-border bg-card p-4">
                ...
                <div className="space-y-2">
                    {languages.map((lang) => (
                        <Button
                            key={lang.id}
                            variant={selectedLanguage === lang.id ? "solid" : "flat"}
                            className="w-full justify-start gap-2 h-12 rounded-md"
