...
interface StartProps {
  ...
  setAssessmentType: React.Dispatch<React.SetStateAction<AssessmentType>>;
  assessment: PopulatedAssessment;
  setAssessment: React.Dispatch<React.SetStateAction<PopulatedAssessment>>;
...
const Start: React.FC<StartProps> = ({
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const { type, instructions, assessment } = response.data.data;
  ...
  }, [userInput, setAssessmentType, setAssessment]);
      ...
      <Card className="p-4 h-[70vh] w-[70vw]">
        ...
        <CardBody>
          <p className="px-5 overflow-y-auto">
            ...
            <pre>{DEFAULT_INSTRUCTIONS[assessmentType]}</pre>
