const PrivacyPolicy = () => {
  return (
    <div className="bg-background text-foreground min-h-screen p-8 pt-20 opacity-80">
          ...
          <div className="p-6">
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2">
              ...
              <li>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Scriptopia,
                Mumbai.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Scriptopia, accessible from{" "}
                <a
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2">
              ...
              <li>
                ...
                purchased or enquired about unless you've opted not to receive
                search information
              </li>
              <li>
                <p>
            ...
            <ul className="list-disc list-inside mt-4 mb-4">
              <li>
                <strong>To comply with a legal obligation:</strong> Comply with
                any applicable laws, regulations, or legal processes.
              </li>
              <li>
                <strong>To protect and defend the Company:</strong> Protect and
                defend the rights or property of the Company.
              </li>
              <li>
                <strong>To prevent or investigate possible wrongdoing:</strong>{" "}
                Prevent or investigate possible wrongdoing in connection with
                the Service.
              </li>
              <li>
                <strong>To protect the personal safety of Users:</strong>{" "}
                Protect the personal safety of Users of the Service or the
                public.
              </li>
              <li>
                <strong>To protect against legal liability:</strong> Protect
            ...
            <ul>
              <li>By email: privacy@scriptopia.tech</li>
            </ul>
          </div>
        </div>
      </div>
