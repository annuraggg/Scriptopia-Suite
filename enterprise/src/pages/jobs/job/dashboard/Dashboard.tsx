...
interface Participant {
  ...
  email: string;
  phone: string;
  stage: 'Applied' | 'Problem-Solving' | 'Technical' | 'Interview' | 'Evaluation';
  percentage: number;
}
...
const Dashboard: React.FC = () => {
  ...
  const participants: Participant[] = [
    { id: '1', name: 'John Doe', email: 'john@example.com', phone: '123-456-7890', stage: 'Applied', percentage: 25 },
    { id: '2', name: 'Jane Smith', email: 'jane@example.com', phone: '234-567-8901', stage: 'Applied', percentage: 40 },
    { id: '3', name: 'Alice Johnson', email: 'alice@example.com', phone: '345-678-9012', stage: 'Problem-Solving', percentage: 55 },
    { id: '4', name: 'Bob Brown', email: 'bob@example.com', phone: '456-789-0123', stage: 'Technical', percentage: 70 },
    { id: '5', name: 'Charlie Davis', email: 'charlie@example.com', phone: '567-890-1234', stage: 'Interview', percentage: 85 },
    { id: '6', name: 'Diana Evans', email: 'diana@example.com', phone: '678-901-2345', stage: 'Evaluation', percentage: 95 },
  ];
  ...
  const renderParticipantCards = (stage: Participant['stage']) => {
    return participants
      ...
      .map(participant => (
        <Card key={participant.id} className="w-full h-32 flex flex-col bg-zinc-800">
          <CardBody className="flex-grow flex flex-col justify-between overflow-hidden py-2">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-xs text-slate-400 truncate">{participant.phone}</p>
            </div>
            ...
            <Card className="w-full h-20 bg-blue-500 bg-opacity-10">
              <CardBody className="flex flex-col items-center justify-center p-2">
                <div className="flex flex-col-2 items-start gap-2">
                  ...
                  <div>
                    <p className="text-xs text-slate-400">July 1, 2023, 12:00 AM</p>
                    <p className="text-xs text-slate-400">July 2, 2023, 12:00 AM</p>
                  </div>
                </div>
              </CardBody>
            </Card>
